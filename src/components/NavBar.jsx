            ...
            <div className="flex items-center justify-between gap-2 sm:gap-0">
                <div>
                    <Link to="/" className="flex items-center">
                        <img src={logo} alt="logo" className='w-25 h-auto sm:w-25.5 sm:h-9.25 ' />
                    </Link>
                ...
                <div className='flex justify-center items-center gap-2 sm:gap-5'>
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            className=" hidden lg:inline-flex px-4 py-2  text-white/90 border border-white/20  bg-white/5 rounded-lg  hover:bg-white/10 transition text-sm font-medium cursor-pointer"
                        >
                            Log In
                        </button>

                        <button
                            className="hidden lg:inline-flex px-4 py-2 bg-[#df2144]  text-black rounded-lg font-semibold text-sm  hover:bg-[#c81c3b] transition cursor-pointer"
                        >
                            Sign Up
                        </button>
                    </div>
