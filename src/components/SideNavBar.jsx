...
function SideNavBar({
  ...
  return (
    <section className='absolute z-80 bg-linear-to-br from-gray-900/95 via-black/98 to-gray-900 border border-red-400 p-5 top-17 right-0 h-auto w-2/3 rounded-xl md:hidden space-y-5'>
