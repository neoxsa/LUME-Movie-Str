...
function SearchItems({
    ...
    return (
        ...
        >
            ...
            {results?.length > 0 && (
                <div
                    className="fixed md:absolute inset-x-0 md:left-0 top-18 md:top-full bg-black/95 border border-white/10 rounded-t-xl md:rounded-xl p-3 md:p-5 max-h-[60vh] md:max-h-96 overflow-y-auto z-50 custom-scrollbar"
